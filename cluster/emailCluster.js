...
if (cluster.isPrimary) {
    console.log(`📧 Email Cluster Master (PID: ${process.pid}) starting...`);
    
    const workerCount = parseInt(process.env.EMAIL_WORKERS) || Math.min(os.cpus().length, 4);
    console.log(`Spawning ${workerCount} email workers...`);
